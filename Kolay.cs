    ...
    public partial class Kolay : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM cografya1 WHERE Id = @randomId", baglan);
            ...
            if (soruNo == 2)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM cografya2 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 3)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM matematik1 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 4)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM matematik2 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 5)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM sanat1 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 6)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM sanat2 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 7)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM spor1 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 8)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM spor2 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 9)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM tarih1 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if (soruNo == 10)
            {
                ...
                OleDbCommand komut = new OleDbCommand("SELECT * FROM tarih2 WHERE Id = @randomId", baglan);
                komut.Parameters.AddWithValue("@randomId", randomId);
            ...
            if(soruNo==12)
            {
                SonucKolay sonuc = new SonucKolay();
                sonuc.Show();
                this.Visible = false;
            }
            baglan.Close();
